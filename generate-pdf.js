...
const skillsData = [
  ...
  { cat: "Tools", list: "Git, GitHub, Bitbucket, Postman, Visual Studio, SQL Workbench, AWS EC2, Swagger" },
  { cat: "Concepts", list: "3-Tier Architecture, OOPS, MVC, REST APIs, Query Optimization, Cloud Scalability, SDLC" }
];
...
doc.setFontSize(9.5);
doc.setTextColor(...primaryColor);
doc.text("Event Management System", 15, y);
doc.text("C#, SQL Server", 195, y, { align: "right" });
y += 4.5;

doc.setFont("helvetica", "normal");
doc.setFontSize(9);
doc.setTextColor(51, 65, 85);
doc.text("–  Developed a scalable event management system enabling booking and service management workflows.", 18, y);
y += 4.2;
doc.text("–  Integrated SQL Server database using ADO.NET for authentication and data management.", 18, y);
y += 5.5;
...
doc.setFontSize(9.5);
doc.setTextColor(...primaryColor);
doc.text("Contact Management System", 15, y);
doc.text("MERN Stack", 195, y, { align: "right" });
y += 4.5;

doc.setFont("helvetica", "normal");
doc.setFontSize(9);
doc.setTextColor(51, 65, 85);
doc.text("–  Developed REST APIs and integrated frontend with backend services.", 18, y);
y += 4.2;
doc.text("–  Implemented features for create, update, delete, and search operations.", 18, y);
y += 5.5;
